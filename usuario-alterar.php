                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-12 col-md-offset-1">
                            <div>
                                ...
                                <input type="text" name="logradouro" value="<?php echo $usuario['logradouro']; ?>" class="form-control" required/>
                            </div>
                        </div>
                        <div class="col-md-2 col-sm-12">
                            <div>
                                <label>Numero:</label>
                                <input type="number" name="numero" value="<?php echo $usuario['numero']; ?>" class="form-control" required/>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-12">
                            <div>
                                <label>Bairro:</label>
                                <input type="text" name="bairro" class="form-control" value="<?php echo $usuario['bairro']; ?>" required/>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4 col-sm-12 col-md-offset-1">
                            <div>
                                <label>Cidade:</label>
                                <input type="text" name="cidade" value="<?php echo $usuario['cidade']; ?>" class="form-control" required/>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-12">
                            <div>
                        ...
                        <div class="col-md-3 col-sm-12">
                            <div>
                                <label>CEP:</label>
                                <input type="text" name="cep" value="<?php echo $usuario['cep']; ?>" class="form-control" required/>
                            </div>
                        </div>
                    </div>
                    <div class="row">
